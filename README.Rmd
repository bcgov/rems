...
**As of March 2026, this package is deprecated and is no longer maintained.**

The package is frozen for reproducibility and to allow users time to transition to the new system. Data accessible using `rems` is current to February 26, 2026. 

Please use the replacement package **[`renmods`](https://github.com/bcgov/renmods)**. The move to `renmods` follows the release of the new [B.C. Environmental Monitoring Data System (EnMoDs)](https://www2.gov.bc.ca/gov/content/environment/research-monitoring-reporting/monitoring/environmental-monitoring-data-system) as a replacement for EMS. 
